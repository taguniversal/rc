...
int process_osc_message(sqlite3* db, const char *buffer, const char* block, int len) {
    ...
    if (tosc_parseMessage(&osc, (char *)buffer, len) == 0) {
        ...
        #define STORE_TRIPLE3(subject, pred, value) \
            do { insert_triple(db, block, subject, pred, value); side_effect = 1; } while (0)
        ...
        if (strcmp(osc.buffer, "/button1") == 0) {
            ...
            STORE_TRIPLE3("/button1", "context", enrich("/button1"));
            STORE_TRIPLE3("/button1", "pressedValue", val_str);
            STORE_TRIPLE3("/button1", "timestamp", iso_timestamp);
        ...
        if (strncmp(osc.buffer, "/grid1/", 7) == 0) {
            ...
            STORE_TRIPLE3("/grid1", "context", enrich("/grid1"));
            STORE_TRIPLE3(subject, "rowValue", val_str);
            STORE_TRIPLE3(subject, "timestamp", iso_timestamp);
        }
        ...
        if (strcmp(osc.buffer, "/radar1") == 0) {
            ...
            STORE_TRIPLE3("/radar1", "context", enrich("/radar1"));
            STORE_TRIPLE3("/radar1", "hasX", x_str);
            STORE_TRIPLE3("/radar1", "hasY", y_str);
            STORE_TRIPLE3("/radar1", "timestamp", iso_timestamp);
        }
        ...
        if (strcmp(osc.buffer, "/pager1") == 0) {
            ...
            STORE_TRIPLE3("/pager1", "context", enrich("/pager1"));
            STORE_TRIPLE3("/pager1", "selectedPage", page_str);
            STORE_TRIPLE3("/pager1", "timestamp", iso_timestamp);
        }
        ...
        if (strcmp(osc.buffer, "/encoder1") == 0) {
            ...
            STORE_TRIPLE3("/encoder1", "context", enrich("/encoder1"));
            STORE_TRIPLE3("/encoder1", "rotatedTo", value_str);
            STORE_TRIPLE3("/encoder1", "timestamp", iso_timestamp);
        }
        ...
        if (strcmp(osc.buffer, "/radio1") == 0) {
            ...
            STORE_TRIPLE3("/radio1", "context", enrich("/radio1"));
            STORE_TRIPLE3("/radio1", "selectedOption", sel_str);
            STORE_TRIPLE3("/radio1", "timestamp", iso_timestamp);
        }
        ...
        if (strcmp(osc.buffer, "/xy1") == 0) {
            ...
            STORE_TRIPLE3("/xy1", "context", enrich("/xy1"));
            STORE_TRIPLE3("/xy1", "positionX", x_str);
            STORE_TRIPLE3("/xy1", "positionY", y_str);
            STORE_TRIPLE3("/xy1", "timestamp", iso_timestamp);
        }
        ...
        if (strcmp(osc.buffer, "/fader5") == 0) {
            ...
            STORE_TRIPLE3("/fader5", "context", enrich("/fader5"));
            STORE_TRIPLE3("/fader5", "faderValue", value_str);
            STORE_TRIPLE3("/fader5", "timestamp", iso_timestamp);
        }
    } else {
